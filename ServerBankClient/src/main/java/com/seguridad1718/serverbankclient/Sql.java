...
public class Sql {
    ...
    private static String BD_USER = "bancoadmin";
    private static String BD_PASSWORD = "fresa*1984";
    private static String BD_URL = "jdbc:postgresql://localhost/bancocliente";
